...
{
    public async Task<List<CompraDetalleConFechaDto>> MergeComprasConDetallesAsync(
    ...
    )
    {
        ...
        using (var workbook = new XLWorkbook(stream))
        {
            ...
            var filaHeader = EncontrarFilaHeader(ws, new[] { "NRO", "FECHA" });
        ...
        using (var workbook = new XLWorkbook(stream))
        {
            ...
            var filaHeader = EncontrarFilaHeader(ws, new[] { "NRO", "PROVEEDOR", "CANT", "TOTAL" });
            ...
            var nroCol = EncontrarColumna(ws, filaHeader, "NRO");
            var proveedorCol = EncontrarColumna(ws, filaHeader, "PROVEEDOR");
            var productoCol = EncontrarColumna(ws, filaHeader, "PRODUCTO"); 
            var cantidadCol = EncontrarColumna(ws, filaHeader, "CANT");
            var totalCol = EncontrarColumna(ws, filaHeader, "TOTAL");
